    ...
    return (
        <div className="mx-auto grid grid-cols-12 content-center
            ...
            <div className="md:hidden col-span-6 flex justify-end">
                <button data-collapse-toggle="navbar-default" type="button" class="p-2 ml-3 text-sm text-black rounded-lg focus:ring-2 focus:ring-black" aria-controls="navbar-default" aria-expanded="false">
